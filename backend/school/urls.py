...
from .views import (
    ...
    TeacherLessonMaterialsView, TeacherMaterialDetailView, TeacherInlineImageView,
...
urlpatterns = [
    ...
    path('teacher/inline-image/', TeacherInlineImageView.as_view(), name='school-teacher-inline-image'),
