...
const dict = {
  es: {
    ...
    teacher: {
      ...
      crearCurso: '+ Crear curso', cancelar: 'Cancelar',
      nombreCurso: 'Nombre del curso', descripcionCurso: 'Descripción (opcional)',
      creando: 'Creando...', crear: 'Crear curso', nombreRequerido: 'El nombre del curso es obligatorio.',
    },
  ...
  ru: {
    ...
    teacher: {
      ...
      crearCurso: '+ Создать курс', cancelar: 'Отмена',
      nombreCurso: 'Название курса', descripcionCurso: 'Описание (необязательно)',
      creando: 'Создаём...', crear: 'Создать курс', nombreRequerido: 'Название курса обязательно.',
    },
  ...
  en: {
    ...
    teacher: {
      ...
      crearCurso: '+ Create course', cancelar: 'Cancel',
      nombreCurso: 'Course name', descripcionCurso: 'Description (optional)',
      creando: 'Creating...', crear: 'Create course', nombreRequerido: 'Course name is required.',
    },
