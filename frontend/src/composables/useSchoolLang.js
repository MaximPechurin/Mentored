...
const dict = {
  es: {
    ...
    course: {
      ...
      grupoWhatsapp: 'Grupo de WhatsApp',
    },
    leccion: {
    ...
    teacher: {
      ...
      datosCurso: 'Datos del curso', editar: 'Editar', sinDescripcion: 'Sin descripción todavía.',
      guardar: 'Guardar', lecciones: 'Lecciones', anadirLeccion: '+ Añadir lección', anadir: 'Añadir',
      sinLecciones: 'Este curso aún no tiene lecciones.', editarLeccion: 'Editar lección',
      tareas: 'Tareas', obligatoria: 'Obligatoria', opcional: 'Opcional',
      hacerOpcional: 'Hacer opcional', hacerObligatoria: 'Hacer obligatoria', anadirTarea: '+ Añadir tarea',
      nombreLeccion: 'Título de la lección', contenidoLeccion: 'Contenido / texto de la lección',
      duracionMin: 'Duración (min)', subirVideo: 'Subir archivo', enlaceVideo: 'Enlace (YouTube/Vimeo)',
      nombreTarea: 'Título de la tarea', descripcionTarea: 'Descripción de la tarea',
      puntosMax: 'Puntos máximos', obligatoriaLabel: 'Obligatoria para completar la lección',
      editarCurso: 'Editar curso', grupoWhatsapp: 'Enlace del grupo de WhatsApp (opcional)',
      materiales: 'Materiales', anadirMaterial: '+ Añadir material', nombreMaterial: 'Nombre del material',
      archivoMaterial: 'Archivo (PDF u otro)', eliminar: 'Eliminar', sinMateriales: 'Sin materiales todavía.',
      soloVideo: 'En este campo solo se puede subir un video. Para PDF y otros archivos usa «Materiales».',
    },
  ...
  ru: {
    ...
    course: {
      ...
      grupoWhatsapp: 'Группа в WhatsApp',
    },
    leccion: {
    ...
    teacher: {
      ...
      datosCurso: 'Данные курса', editar: 'Изменить', sinDescripcion: 'Пока без описания.',
      guardar: 'Сохранить', lecciones: 'Уроки', anadirLeccion: '+ Добавить урок', anadir: 'Добавить',
      sinLecciones: 'В этом курсе пока нет уроков.', editarLeccion: 'Редактировать урок',
      tareas: 'Домашние задания', obligatoria: 'Обязательное', opcional: 'Необязательное',
      hacerOpcional: 'Сделать необязательным', hacerObligatoria: 'Сделать обязательным', anadirTarea: '+ Добавить задание',
      nombreLeccion: 'Название урока', contenidoLeccion: 'Текст / содержание урока',
      duracionMin: 'Длительность (мин)', subirVideo: 'Загрузить файл', enlaceVideo: 'Ссылка (YouTube/Vimeo)',
      nombreTarea: 'Название задания', descripcionTarea: 'Описание задания',
      puntosMax: 'Максимальный балл', obligatoriaLabel: 'Обязательно для завершения урока',
      editarCurso: 'Редактировать курс', grupoWhatsapp: 'Ссылка на группу в WhatsApp (необязательно)',
      materiales: 'Материалы', anadirMaterial: '+ Добавить материал', nombreMaterial: 'Название материала',
      archivoMaterial: 'Файл (PDF или другой)', eliminar: 'Удалить', sinMateriales: 'Материалов пока нет.',
      soloVideo: 'В это поле можно загрузить только видео. Для PDF и других файлов используйте «Материалы».',
    },
  ...
  en: {
    ...
    teacher: {
      ...
      datosCurso: 'Course details', editar: 'Edit', sinDescripcion: 'No description yet.',
      guardar: 'Save', lecciones: 'Lessons', anadirLeccion: '+ Add lesson', anadir: 'Add',
      sinLecciones: 'This course has no lessons yet.', editarLeccion: 'Edit lesson',
      tareas: 'Homework', obligatoria: 'Required', opcional: 'Optional',
      hacerOpcional: 'Make optional', hacerObligatoria: 'Make required', anadirTarea: '+ Add assignment',
      nombreLeccion: 'Lesson title', contenidoLeccion: 'Lesson content / text',
      duracionMin: 'Duration (min)', subirVideo: 'Upload file', enlaceVideo: 'Link (YouTube/Vimeo)',
      nombreTarea: 'Assignment title', descripcionTarea: 'Assignment description',
      puntosMax: 'Max score', obligatoriaLabel: 'Required to complete the lesson',
      editarCurso: 'Edit course', grupoWhatsapp: 'WhatsApp group link (optional)',
      materiales: 'Materials', anadirMaterial: '+ Add material', nombreMaterial: 'Material name',
      archivoMaterial: 'File (PDF or other)', eliminar: 'Delete', sinMateriales: 'No materials yet.',
      soloVideo: 'Only a video can be uploaded here. For PDF and other files use “Materials”.',
    },
